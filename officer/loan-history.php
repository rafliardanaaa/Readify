<?php
    ...
    $loan_completed = mysqli_query($conn, $loan);
            ...
            <div class="px-8">
                <div class="flex justify-between">
                    <div class="px-2">
                        <ul class="flex items-center">
                            ...
                            <li class="inline-flex items-center">
                                <a href="" class="text-sky-600">Riwayat Pinjaman</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="w-full my-4 flex justify-between">
                    <div class="flex">
                        ...
                        <div>
                            <div class="px-4 py-3">
                                <a href="" class="font-semibold text-sky-600">Riwayat Pinjaman</a>
                            </div>
                ...
                <div class="bg-white px-4 py-3 rounded-lg shadow-md">
                    <table class="w-full">
                        ...
                        <?php foreach($loan_completed as $row): ?>
                        <tr>
