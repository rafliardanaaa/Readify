            ...
            <div class="px-8">
                ...
                <div class="w-full my-4 flex justify-between">
                    ...
                    <div class="flex items-center">
                        <div class="mr-2">
                            <a href="category-list/print-category.php" target="blank">
                        ...
                        <div class="mr-2">
                                <a href="category-list/add-category.php">
                                    <div class="bg-white px-4 py-3 text-gray-400 font-semibold rounded-md hover:text-sky-600 hover:shadow-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <div class="bg-white px-4 py-3 rounded-lg shadow-md">
                    <table class="w-full">
                        ...
                        <tr class="">
                            ...
                            <td><a href="category-list/edit-category.php?id=<?= $row['KategoriID'] ?>">Sunting</a></td>
