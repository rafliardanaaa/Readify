<?php
    ...
    $category_amount = mysqli_query($conn, "SELECT COUNT(*) AS category_count FROM kategoribuku_relasi");
    $row = mysqli_fetch_assoc($category_amount);
    $amount = $row['category_count'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="px-8">
                <div class="flex justify-between">
                    <div class="px-2">
                        <ul class="flex items-center">
                            ...
                            <li class="inline-flex items-center">
                                <a href="" class="text-sky-600">Kelola Kategori</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="w-full my-4 flex justify-between">
                    <div class="flex">
                        <div class="">
                            <div class="px-4 py-3">
                                <a href="book-list.php" class="font-semibold hover:text-sky-600">Kelola Buku</a>
                            </div>
                        </div>
                        <div>
                            <div class="px-4 py-3">
                                <a href="" class="font-semibold text-sky-600">Kelola Kategori</a>
                            </div>
                ...
                <div class="bg-white px-4 py-3 rounded-lg shadow-md">
                    <table class="w-full">
                        <tr>
                            <th class="w-2/5">Nama Kategori</th>
                            <th class="w-2/5">Jumlah</th>
                            <th class="w-1/12">Kelola</th>
                        </tr>
                        <?php foreach($category as $row): ?>
                        <tr class="">
                            <td><?= $row['NamaKategori']; ?></td>
                            <td class="text-center"><?php echo $category_amount; ?></td>
