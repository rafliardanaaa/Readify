                ...
                <div class="bg-white mt-4 p-4 rounded-lg shadow-md">
                    ...
                    <div class="mt-4">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <select name="category" placeholder="Pilih kategori buku" class="h-10 w-full my-1.5 px-3 border-grey-400 border-2 rounded-md focus:outline-none focus:border-sky-600 focus:border-2 focus:text-black" autocomplete="off" required>
