<?php
    ...
    $account = query("SELECT * FROM user WHERE Status = '1'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="px-8">
                <div class="flex justify-between">
                    <div class="px-2">
                        <ul class="flex items-center">
                            ...
                            <li class="inline-flex items-center">
                                <a href="account-list.php" class="text-sky-600">Akun Petugas</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="w-full my-4 flex justify-between">
                    <div class="flex">
                        <div class="">
                            <div class="px-4 py-3">
                                <a href="account-list.php" class="font-semibold hover:text-sky-600">Akun Peminjam</a>
                            </div>
                        </div>
                        <div>
                            <div class="px-4 py-3">
                                <a href="" class="font-semibold text-sky-600">Akun Petugas</a>
                            </div>
